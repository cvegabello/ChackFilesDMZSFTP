...
Module Sftp
    ...
    End Function
    Function connectSFTP(ByRef sftp As Chilkat.SFtp, ByVal hostName As String, ByVal port As Integer, ByVal username As String, ByVal password As String, ByRef strError As String) As Integer
